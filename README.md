...
* [Build a Budget app with Appwrite And Flutter](https://dev.to/1995yogeshsharma/create-a-budget-app-using-flutter-and-appwrite-2c96-temp-slug-9407482)
...
* **Budget app with Appwrite and Flutter** - A simple budget-app for managing income / expense transaction and viewing history. Also, provides multi user access [Source Code](https://github.com/1995YogeshSharma/budget-app)
